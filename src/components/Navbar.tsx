  ...
  return (
    <nav className="flex items-center justify-between py-4 px-6 bg-background border-b">
      ...
      <div className="flex items-center space-x-1 sm:space-x-4">
        <Link
          href={"/courses"}
          className="flex items-center gap-1 px-3 py-2 rounded-md text-sm text-muted-foreground hover:text-primary hover:bg-secondary transition-colors"
        >
        ...
        {/* this will be show if user signed in */}
        <UserButton />
